 ...
 * `tools/pre-execute` is frozen at assemble — 0.1.1-rc.2 still persists `assistant/message`
...
/** 0.1.1-rc.2 `tools/pre-execute` contract: `{ kind: "deny", reason }`. */
...
/**
 * Flatten a 0.1.1-rc.2 `EpochHeader` into the snapshot request bag.
...
export function apply(ctx, config) {
  ...
  // Survives the per-turn pending bag: 0.1.1-rc.2 still appends `request/header` only when
  ...
  // *returned* AssembledSection is ignored by 0.1.1-rc.2 (complete is captured
