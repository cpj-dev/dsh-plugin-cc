...
4. Bump `HARNESS_NPM_VERSION` (and `HARNESS_SDK_JSONRPC_PEER_SPECS` if the server's peers changed) in `lib/dsh.mjs` and the pin at the top of this file and in the root README.
